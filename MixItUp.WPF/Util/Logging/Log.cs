...
namespace MixItUp.WPF.Util.Logging
{
    [DebuggerStepThrough]
    public class Log
    {
        ...
        internal static void Initialize()
        {
            ...
            var logFile = Path.Combine(logDir, "miu_" + DateTime.Now.ToString("MM-dd-yyyy") + "log.txt");
        ...
        private static void WriteLine(string msg, LogType type, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "")
        {
#if (!DEBUG)
